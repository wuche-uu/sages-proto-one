...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Scale a GameObject by a size")]
	public class LeanTweenScaleBy : FsmStateAction
	{
		public enum LTLoop
		{
			once,
		...
		[RequiredField]
		[Tooltip("Gameobject that you wish to scale")]
		public FsmOwnerDefault gameObject;
		
		[RequiredField]
		[Tooltip("Scale by")]
		public FsmVector3 addToScale;
		...
		public override void OnEnter()
		{
			...
			Vector3 final = go.transform.localScale + addToScale.Value;

			LTDescr tween  = LeanTween.scale(go, final, time.Value);
