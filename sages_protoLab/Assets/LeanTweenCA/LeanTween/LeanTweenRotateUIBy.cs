...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Rotate a RectTransform object by a degree (used in Unity GUI in 4.6+, for Buttons, Panel, Scrollbar, etc...)")]
	public class LeanTweenRotateUIBy : FsmStateAction
	{
		public enum LTLoop
		{
			once,
