...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class LeanTweenRotateY : FsmStateAction
	{
		public enum LTLoop
		{
			once,
		...
		[RequiredField]
		[Tooltip("The final y-axis rotation with which to rotate")]
		...
		public override void OnEnter()
		{
			...
			LTDescr tween  = LeanTween.rotateY(go, rotation.Value, time.Value);
