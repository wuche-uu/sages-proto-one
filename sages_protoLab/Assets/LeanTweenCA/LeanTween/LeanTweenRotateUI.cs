...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Rotate a RectTransform object (used in Unity GUI in 4.6+, for Buttons, Panel, Scrollbar, etc...)")]
	public class LeanTweenRotateUI : FsmStateAction
	{
		public enum LTLoop
		{
			once,
		...
		public override void OnEnter()
		{
			...
			LTDescr tween = LeanTween.rotate(go.GetComponent<RectTransform>(), degrees.Value, time.Value);
