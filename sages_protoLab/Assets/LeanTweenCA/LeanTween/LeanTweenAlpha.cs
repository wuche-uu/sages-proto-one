...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Fade a gameobject's material to a certain alpha value. The material's shader needs to support alpha.")]
	public class LeanTweenAlpha : FsmStateAction
	{
		public enum LTLoop
		{
			once,
		...
		[RequiredField]
		[Tooltip("Gameobject that you wish to fade")]
		public FsmOwnerDefault gameObject;
		
		[RequiredField]
		[Tooltip("the final alpha value (0-1")]
		public FsmFloat alpha;
		
		[Tooltip("The time with which to fade the object")]
		...
		public override void OnEnter()
		{
			...
			LTDescr tween  = LeanTween.alpha(go, alpha.Value, time.Value);
