...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Move a GameObject along a set of bezier curves, in local space")]
	public class LeanTweenMoveLocal : FsmStateAction
	{
		public enum LTLoop
		{
			once,
		...
		public override void OnEnter()
		{
			...
			LTDescr tween  = LeanTween.moveLocal(go, vector.Value, time.Value);
