...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class LeanTweenUIRotateAroundLocal : FsmStateAction
	{
		public enum LTLoop
		{
			once,
		...
		public override void OnEnter()
		{
			...
			LTDescr tween = LeanTween.rotateAroundLocal(go.GetComponent<RectTransform>(), vector.Value, degrees.Value, time.Value);
