...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Rotate a GameObject in the objects local space (on the transforms localEulerAngles object)")]
	public class LeanTweenRotateLocal : FsmStateAction
	{
		public enum LTLoop
		{
			once,
		...
		[RequiredField]
		[Tooltip("To The final position with which to rotate to")]
		...
		public override void OnEnter()
		{
			...
			LTDescr tween  = LeanTween.rotateLocal(go, vector.Value, time.Value);
