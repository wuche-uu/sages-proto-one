...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Scale a GameObject to a certain size along the x-axis only")]
	public class LeanTweenScaleX : FsmStateAction
	{
		public enum LTLoop
		{
			once,
		...
		[RequiredField]
		[Tooltip("the size with which to scale to")]
		...
		public override void OnEnter()
		{
			...
			LTDescr tween  = LeanTween.scaleX(go, scale.Value, time.Value);
