...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Rotate a GameObject, to values are in passed in degrees")]
	public class LeanTweenRotate : FsmStateAction
	{
		public enum LTLoop
		{
			once,
		...
		public override void OnEnter()
		{
			...
			LTDescr tween  = LeanTween.rotate(go, vector.Value, time.Value);
