...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Move a GameObject through a set of points")]
	public class LeanTweenMoveSpline : FsmStateAction
	{
		public enum LTLoop
		{
			once,
		...
		public override void OnEnter()
		{
			...
			LTDescr tween  = LeanTween.moveSpline(go, tweenVector, time.Value);
