...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Move a GameObject along a set of bezier curves")]
	public class LeanTweenMoveLocalAlongPath : FsmStateAction
	{
		public enum LTLoop
		{
			once,
		...
		[RequiredField]
		[Tooltip("A set of points that define the curve(s), must be sets of 4")]
