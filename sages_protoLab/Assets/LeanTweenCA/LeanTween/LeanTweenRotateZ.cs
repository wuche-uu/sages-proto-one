...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Rotate a GameObject only on the Z axis")]
	public class LeanTweenRotateZ : FsmStateAction
	{
		public enum LTLoop
		{
			once,
		...
		[RequiredField]
		[Tooltip("The final z-axis rotation with which to rotate")]
		...
		public override void OnEnter()
		{
			...
			LTDescr tween  = LeanTween.rotateZ(go, rotation.Value, time.Value);
