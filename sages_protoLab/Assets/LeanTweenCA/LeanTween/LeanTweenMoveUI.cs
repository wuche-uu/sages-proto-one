...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Move a Unity UI RectTransform to a certain location")]
	public class LeanTweenMoveUI : FsmStateAction
	{
		public enum LTLoop
		{
			once,
		...
		public override void OnEnter()
		{
			...
			LTDescr tween = LeanTween.move(go.GetComponent<RectTransform>(), vector.Value, time.Value);
