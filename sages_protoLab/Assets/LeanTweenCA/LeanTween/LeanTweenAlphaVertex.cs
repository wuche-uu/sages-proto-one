...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("This works by tweening the vertex colors directly.")]
	public class LeanTweenAlphaVertex : FsmStateAction
	{
		public enum LTLoop
		{
			once,
		...
		public override void OnEnter()
		{
			...
			LTDescr tween  = LeanTween.alphaVertex(go, alpha.Value, time.Value);
