...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Rotate a GameObject, by values passed in degrees")]
	public class LeanTweenRotateBy : FsmStateAction
	{
		public enum LTLoop
		{
			once,
		...
		public override void OnEnter()
		{
			...
			Vector3 final = go.transform.eulerAngles + vector.Value;

			Fsm.Event (onStartEvent);
			LTDescr tween  = LeanTween.rotate(go, final, time.Value);
